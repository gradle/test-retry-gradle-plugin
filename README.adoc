...
When delegating test execution to Gradle, each execution is reported discretely as for the test reports. Running tests with no Gradle delegation causes tests to not be retried.
